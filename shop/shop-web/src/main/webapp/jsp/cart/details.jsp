...
<script>
    ...
    $("#placeOrder").click(function () {
        const data = JSON.stringify(getProductOrders(getProductIds()));
        const url = "/online-shop/order/place";
        sendRequest("POST", url, function (success) {
            if (success)
                redirectToHome();
        }, null, data);
    });
    ...
    $("#updateCart").click(function () {
        const data = JSON.stringify(getProductOrders(getProductIds()));
        const url = "/online-shop/cart/update";
    ...
    $(".removeButton").click(function () {
        ...
        const productId = getProductId(element.id);
        const url = "/online-shop/cart/product?" + $.param({
            "productId": productId
        });
