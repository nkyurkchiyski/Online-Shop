...
<%
    final List<CategoryDto> categories = (List<CategoryDto>)request.getAttribute("categories");
%>
<html>
<head>
					...
					<div class="card-body">
						<form class="form-horizontal" action="/online-shop/product/search"
							...
							<div class="form-group row">
								<label for="term" class="col-md-4 col-form-label text-md-right">Search
									Term</label>
								<div class="col-md-6">
							...
							<div class="form-group row">
								...
								<div class="col-md-3">
									<input type="number" min="0" max="2147483646" step="0.01"
