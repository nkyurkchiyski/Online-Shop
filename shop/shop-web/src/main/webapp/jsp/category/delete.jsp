            ...
            <div class="col-md-5">
                <div class="card shadow">
                    <div class="card-header form-title bg-warning">
                        <h4 class="m-0">Delete Category</h4>
                    </div>
                    <div class="card-body">
                        <form class="form-horizontal" action="/online-shop/category/delete"
                            method="post">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="name" name="name" placeholder="Name"
                                        class="form-control" disabled value="<%=category.getName()%>" required>
                                </div>
                            </div>
