...
public class OrderController extends BaseController {
    ...
    @Endpoint(urls = "/order/product/remove")
    ...
    public void updateProductFromCartPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        //TODO implement
        resp.sendRedirect("/online-shop/order/cart");
    }
