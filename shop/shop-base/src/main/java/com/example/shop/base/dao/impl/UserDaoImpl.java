...
public class UserDaoImpl implements UserDao {
    ...
    public User findByUserName(String userName) {
        ...
        User user = this.entityManager
                .createQuery("SELECT u FROM t_Users u WHERE u.cUserName = :userName", User.class)
    ...
    public User findByEmail(String email) {
        this.entityManager.getTransaction().begin();
        User user = this.entityManager
                .createQuery("SELECT u FROM t_Users u WHERE u.cUserEmail = :email", User.class)
    ...
    public List<User> findAll() {
        ...
        List<User> users = this.entityManager
                .createQuery("SELECT u FROM t_Users u", User.class)
                .getResultList();
        this.entityManager.getTransaction().commit();
        return users;
    }
